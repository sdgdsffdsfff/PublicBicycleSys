$(function() {
	...
	$(".loginBtn").hover(function() {
		$(".loginBtn").attr("src", "/PublicBicycleSys/images/User/login2.png");
	}, function() {
		$(".loginBtn").attr("src", "/PublicBicycleSys/images/User/login1.png");
	});
	/*
...
function _hyz() {
	...
	$("#vCode").attr("src",
			"/PublicBicycleSys/VerifyCodeServlet?a=" + new Date().getTime());
